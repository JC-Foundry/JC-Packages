...
- An identity package registered, so that JC.Core's `IUserInfo` resolves — messaging is user-scoped. JC.Identity supplies it for local ASP.NET Identity; JC.Identity.Shared alone is enough for any other authority
